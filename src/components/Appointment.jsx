      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          ...
          <div className="mb-8 max-w-md rounded-xl2 border border-gold/40 bg-white px-5 py-4">
            ...
            <p className="font-body text-3xl font-semibold text-forest leading-tight tracking-tight">
              ₹500<span className="text-lg font-normal text-charcoal/50">/-</span>
            </p>
            <p className="text-sm text-charcoal/60 mt-1">Per consultation</p>
            <p className="text-sm text-charcoal/50 mt-0.5">(Medicine not included)</p>
          </div>
